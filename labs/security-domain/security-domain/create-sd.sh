...
sh /opt/eap/bin/jboss-cli.sh --connect "/subsystem=security/security-domain=userroles/authentication=classic:add(login-modules=[{'code'=>'UsersRoles', 'flag'=>'required', 'module-options'=>['usersProperties'=>'file:///home/student/JB183/labs/security-domain/hello-users.properties','rolesProperties'=>'file:///home/student/JB183/labs/security-domain/hello-roles.properties'] }])"
